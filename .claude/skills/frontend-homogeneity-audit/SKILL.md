...
description: "Find and compare frontend patterns such as route views, local route state, shared components, composables, stores, and API usage so new work matches established Vue and project conventions."
---
