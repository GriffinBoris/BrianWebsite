...
description: "Find and compare backend patterns such as views, serializers, services, URLs, app layout, and tests so new work matches established Django and Python conventions."
---
